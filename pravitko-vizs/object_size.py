# in a terminal
# pip install opencv-contrib-python numpy scipy matplotlib ipython jupyter pandas sympy nose
...
videocapture=cv2.VideoCapture('movie1.mov')
...
while(showLive):
    ...
    rotated_frame = rotateImage(frame, 37)
    ...
    frame_resize = cv2.bitwise_and(rotated_frame,rotated_frame,mask = mask)
    ...
    areas = [0] #list to hold all areas
